...
.grain{position:fixed;inset:-100%;z-index:2;pointer-events:none;opacity:.055;
...
.scanline{position:fixed;left:0;right:0;height:120px;z-index:2;pointer-events:none;
  background:linear-gradient(180deg,transparent,rgba(140,180,255,.045),transparent);animation:scan 12s linear infinite}
@keyframes scan{from{top:-15%}to{top:110%}}
header{position:relative;z-index:5;display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:12px;
  padding:16px 28px;border-bottom:1px solid var(--line);background:rgba(10,13,18,.75);backdrop-filter:blur(8px)}
...
.ticker{position:relative;z-index:5;overflow:hidden;border-bottom:1px solid var(--line);direction:ltr;
  background:linear-gradient(90deg,rgba(255,176,46,.06),transparent 40%,rgba(79,227,193,.05));padding:8px 0}
.ticker-track{display:flex;gap:34px;width:max-content;animation:tick 26s linear infinite;
  font-family:var(--mono);font-size:.72rem;letter-spacing:2px;color:var(--dim);white-space:nowrap}
...
.panel::before{content:"";position:absolute;top:-1px;right:-1px;width:34px;height:34px;
  border-top:2px solid var(--amber);border-right:2px solid var(--amber);border-radius:0 10px 0 0;opacity:.7;pointer-events:none}
...
.tag{font-family:var(--mono);font-size:.62rem;letter-spacing:2px;color:var(--amber);
  border:1px solid rgba(255,176,46,.35);padding:3px 8px;border-radius:3px;background:rgba(255,176,46,.07)}
.body{padding:20px;display:flex;flex-direction:column;gap:16px}
.tabs{display:grid;grid-template-columns:1fr 1fr;gap:10px}
.tab{font-family:var(--disp);font-weight:700;font-size:.9rem;padding:12px;border:1px solid var(--line);
  background:transparent;color:var(--dim);border-radius:7px;cursor:pointer;transition:.25s}
.tab:hover{border-color:var(--amber);color:var(--text);transform:translateY(-2px)}
.tab.active{background:linear-gradient(135deg,rgba(255,176,46,.16),rgba(255,122,0,.07));
  border-color:var(--amber);color:var(--amber);box-shadow:inset 0 0 18px rgba(255,176,46,.12)}
.dropzone{border:1.5px dashed var(--line);border-radius:8px;padding:18px;text-align:center;color:var(--dim);
  cursor:pointer;transition:.25s;position:relative;font-size:.85rem}
...
#removeImg{position:absolute;top:8px;right:8px;background:var(--rec);border:0;color:#fff;
  width:24px;height:24px;border-radius:50%;cursor:pointer;font-size:.7rem;transition:.2s}
#removeImg:hover{transform:scale(1.15)}
.field-label{font-family:var(--disp);font-weight:700;font-size:.85rem}
textarea{width:100%;min-height:120px;resize:vertical;background:var(--panel2);border:1px solid var(--line);
  border-radius:8px;color:var(--text);font-family:var(--body);font-size:.95rem;padding:14px;line-height:1.8;transition:.25s}
...
.chip{font-family:var(--mono);font-size:.72rem;padding:7px 13px;border:1px solid var(--line);
  background:transparent;color:var(--dim);border-radius:5px;cursor:pointer;transition:.2s;letter-spacing:1px}
...
.generate{font-family:var(--disp);font-weight:900;font-size:1.05rem;padding:16px;border:0;border-radius:8px;cursor:pointer;
  color:#1a1206;background:linear-gradient(135deg,var(--amber),var(--amber-deep));
  display:flex;align-items:center;justify-content:center;gap:10px;transition:.25s;
  box-shadow:0 6px 24px rgba(255,150,20,.25)}
...
.stage{position:relative;aspect-ratio:16/9;background:#05070b;border:1px solid var(--line);border-radius:8px;
...
.render-overlay{position:absolute;inset:0;z-index:4;background:rgba(5,7,11,.85);
  display:flex;flex-direction:column;align-items:center;justify-content:center;gap:14px}
.elapsed{font-family:var(--mono);font-size:2.2rem;font-weight:600;color:var(--amber);
  letter-spacing:3px;text-shadow:0 0 20px rgba(255,176,46,.4)}
...
.shimmer-bar i{display:block;height:100%;width:40%;border-radius:2px;
  background:linear-gradient(90deg,var(--amber-deep),var(--amber),var(--amber-deep));animation:shimmer 1.4s ease-in-out infinite}
@keyframes shimmer{from{transform:translateX(260%)}to{transform:translateX(-120%)}}
.console{background:#05070b;border:1px solid var(--line);border-radius:8px;padding:14px 16px;
  font-family:var(--mono);font-size:.74rem;line-height:2;direction:ltr;text-align:left;
...
.shot{flex:0 0 240px;background:var(--panel2);border:1px solid var(--line);border-radius:8px;
...
.mode-badge{position:absolute;top:8px;right:8px;z-index:2;font-family:var(--mono);font-size:.58rem;
  background:rgba(5,7,11,.85);color:var(--amber);padding:3px 7px;border-radius:3px;border:1px solid rgba(255,176,46,.3)}
footer{position:relative;z-index:5;border-top:1px solid var(--line);padding:18px 28px;
